...
async def main():
    ...
    channel = await client.get_entity('@ZemenExpress')  # change this to a real channel
    messages = []
    ...
    df.to_csv('ZemenExpress_telegram_messages.csv', index=False)
    print("Saved 100 messages to ZemenExpress_telegram_messages.csv")
