...
async def main():
    ...
    channel = await client.get_entity('@Shewabrand')  # change this to a real channel
    messages = []
    ...
    df.to_csv('marakibrand_telegram_messages.csv', index=False)
    print("Saved 100 messages to marakibrand_telegram_messages.csv")
