...
df = pd.read_csv("liyueqa_telegram_messages.csv")
...
df.to_csv("cleaned_liyueqa_messages.csv", index=False)

print("✅ Preprocessing complete! Saved to cleaned_liyueqa_messages.csv")
