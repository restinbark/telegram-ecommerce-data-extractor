...
df = pd.read_csv("marakibrand_telegram_messages.csv")
...
df.to_csv("cleaned_marakibrand_messages.csv", index=False)

print("✅ Preprocessing complete! Saved to cleaned_marakibrand_messages.csv")
