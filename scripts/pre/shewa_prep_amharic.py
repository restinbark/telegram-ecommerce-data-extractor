...
df = pd.read_csv("Shewabrand_telegram_messages.csv")
...
df.to_csv("cleaned_Shewabrand_messages.csv", index=False)

print("✅ Preprocessing complete! Saved to cleaned_Shewabrand_messages.csv")
