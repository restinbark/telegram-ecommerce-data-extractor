...
df = pd.read_csv("ZemenExpress_telegram_messages.csv")
...
df.to_csv("cleaned_ZemenExpress_messages.csv", index=False)

print("✅ Preprocessing complete! Saved to cleaned_ZemenExpress_messages.csv")
